...
//                         text = prefix.substring(0, prefix.length - (prefix.endsWith(',') ? 2 : 1)) + suffix; //if ends with , remove 2 chars
//                       }
...
//                       int finalLength = text.length;

//                       controller.text = text;
//                       controller.selection = TextSelection.collapsed(offset: prefix.length - (initialLength - finalLength));
//                     },
//                     child: Image.asset(
//                       'lib/icons/clear.png',
//                       color: Colors.green,
...
//                                 text = prefix + calculation + suffix;
//                                 text = text.replaceAll(',', ''); //removing all commas
//                                 text = text.replaceAll('\n', '');
...
//                             Text(
//                               '=${commafy(history[index]['result'], context)}',
//                               style: resultStyle,
//                             ),
